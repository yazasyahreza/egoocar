...
<?php
   ...
   $nama = $_GET['nama'];
   $qproduk = mysqli_query($k, "SELECT * FROM produk WHERE nama_produk='$nama'");
   $produk = mysqli_fetch_array($qproduk);

   $qterkait = mysqli_query($k, "SELECT * FROM produk WHERE kategori_id='$produk[kategori_id]'
   LIMIT 4");
...
<body>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-md-3">
            <h3 class="tittle text-center mb-lg-5">Detail Produk</h3>
            <div class="speak px-lg-5">
                <div class="row mt-lg-5 mt-4">
                  <div class="desc1-left col-md-4 mx-auto">
                            <img src="../gambar/<?=$produk['gambar']?>" class="img-fluid" alt="">
                        </div>
                    <div class="col-md-12 events-info my-3">
                        ...
                        <p>Ketersediaan Stock : <strong><?= $produk['stock']?></strong></p>
                    </div>
                </div>
                ...
                <div class="left-ads-display">
                    ...
                    <h3 class="shop-sing">Produk Terkait</h3>
                    <div class="row">
                        <?php while($data=mysqli_fetch_array($qterkait)){?>
                        <div class="col product-men">
                            <div class="product-shoe-info shoe text-center">
                                <a href="produk-detail.php?nama=<?=$data['nama_produk']?>">
        ...
        <div class="container">
            <div class="row footer-top">
                <div class="col-lg-4 footer-grid_section_w3layouts">
                    ...
                    <p> Goocar adalah destinasi online terbaik untuk para pencinta sepatu dan sandal.
                    </p>
